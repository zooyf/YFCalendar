...
- (instancetype)init
{
    if (self=[super init]) {
        ///此处可以修改FPS显示的位置
        self.rateLabel = [[UILabel alloc] initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width-170, 20,150, 20)];
        ...
        ///此处可以修改FPS显示的位置
        self.locationLabel = [[UILabel alloc] initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width-170, 40,150, 20)];
        self.locationLabel.font = [UIFont boldSystemFontOfSize:12.0];
        self.locationLabel.backgroundColor = [UIColor orangeColor];
        self.locationLabel.textColor = [UIColor whiteColor];
        self.locationLabel.textAlignment = NSTextAlignmentCenter;
        
        [[[UIApplication sharedApplication] keyWindow] addSubview:self.locationLabel];
